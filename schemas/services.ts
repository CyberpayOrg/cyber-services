...
export const services: ServiceDef[] = [
  ...
  // ── Cyber API — LLM Gateway ────────────────────────────────────────────
  {
    id: "cyberapi",
    name: "Cyber API",
    url: "https://ai.cyberpay.org",
    serviceUrl: "https://ai.cyberpay.org",
    description:
    ...
    categories: ["ai"],
    integration: "first-party",
    tags: ["llm", "claude", "gpt", "gemini", "deepseek", "grok", "llama", "qwen", "mistral", "openai-compatible", "api-gateway"],
    status: "active",
    docs: { homepage: "https://ai.cyberpay.org" },
    provider: { name: "CyberPay", url: "https://cyberpay.org" },
    realm: "ai.cyberpay.org",
    intent: "charge",
    payment: NANOPAY_PAYMENT,
    endpoints: [
      // ── Anthropic Claude ──
      { route: "POST /v1/chat/completions (anthropic/claude-sonnet-4.6)", desc: "Claude Sonnet 4.6 — fast, intelligent", amount: "3000000", unitType: "1M tokens" },
      { route: "POST /v1/chat/completions (anthropic/claude-opus-4.6)", desc: "Claude Opus 4.6 — most capable", amount: "15000000", unitType: "1M tokens" },
      { route: "POST /v1/chat/completions (anthropic/claude-opus-4.5)", desc: "Claude Opus 4.5", amount: "15000000", unitType: "1M tokens" },
      { route: "POST /v1/chat/completions (anthropic/claude-haiku-4.5)", desc: "Claude Haiku 4.5 — fastest, cheapest", amount: "1000000", unitType: "1M tokens" },
      { route: "POST /v1/chat/completions (anthropic/claude-sonnet-4.5)", desc: "Claude Sonnet 4.5", amount: "3000000", unitType: "1M tokens" },
      { route: "POST /v1/chat/completions (anthropic/claude-3.7-sonnet)", desc: "Claude 3.7 Sonnet", amount: "3000000", unitType: "1M tokens" },
      { route: "POST /v1/chat/completions (anthropic/claude-3.5-haiku)", desc: "Claude 3.5 Haiku", amount: "1000000", unitType: "1M tokens" },
      { route: "POST /v1/chat/completions (anthropic/claude-3.5-sonnet)", desc: "Claude 3.5 Sonnet", amount: "3000000", unitType: "1M tokens" },
      { route: "POST /v1/chat/completions (anthropic/claude-3-opus)", desc: "Claude 3 Opus", amount: "15000000", unitType: "1M tokens" },
      { route: "POST /v1/chat/completions (anthropic/claude-3-haiku)", desc: "Claude 3 Haiku", amount: "250000", unitType: "1M tokens" },
      // ── OpenAI GPT ──
      { route: "POST /v1/chat/completions (openai/gpt-4o)", desc: "GPT-4o — multimodal flagship", amount: "2500000", unitType: "1M tokens" },
      { route: "POST /v1/chat/completions (openai/gpt-4o-mini)", desc: "GPT-4o Mini — fast & cheap", amount: "150000", unitType: "1M tokens" },
      { route: "POST /v1/chat/completions (openai/gpt-5)", desc: "GPT-5 — latest generation", amount: "2000000", unitType: "1M tokens" },
      { route: "POST /v1/chat/completions (openai/o1)", desc: "o1 — reasoning model", amount: "15000000", unitType: "1M tokens" },
      { route: "POST /v1/chat/completions (openai/o3-mini)", desc: "o3 Mini — fast reasoning", amount: "1100000", unitType: "1M tokens" },
      // ── Google Gemini ──
      { route: "POST /v1/chat/completions (google/gemini-2.5-pro-preview)", desc: "Gemini 2.5 Pro — Google's best", amount: "1250000", unitType: "1M tokens" },
      { route: "POST /v1/chat/completions (google/gemini-2.5-flash-preview)", desc: "Gemini 2.5 Flash — fast & cheap", amount: "150000", unitType: "1M tokens" },
      { route: "POST /v1/chat/completions (google/gemini-2.0-flash-001)", desc: "Gemini 2.0 Flash", amount: "100000", unitType: "1M tokens" },
      // ── DeepSeek ──
      { route: "POST /v1/chat/completions (deepseek/deepseek-v3.2)", desc: "DeepSeek V3.2 — best value", amount: "270000", unitType: "1M tokens" },
      { route: "POST /v1/chat/completions (deepseek/deepseek-chat-v3-0324)", desc: "DeepSeek Chat V3", amount: "270000", unitType: "1M tokens" },
      { route: "POST /v1/chat/completions (deepseek/deepseek-r1)", desc: "DeepSeek R1 — reasoning", amount: "550000", unitType: "1M tokens" },
      { route: "POST /v1/chat/completions (deepseek/deepseek-r1-0528)", desc: "DeepSeek R1 (0528)", amount: "550000", unitType: "1M tokens" },
      // ── xAI Grok ──
      { route: "POST /v1/chat/completions (x-ai/grok-3)", desc: "Grok 3 — xAI flagship", amount: "3000000", unitType: "1M tokens" },
      { route: "POST /v1/chat/completions (x-ai/grok-3-mini)", desc: "Grok 3 Mini — fast", amount: "300000", unitType: "1M tokens" },
      // ── Meta Llama ──
      { route: "POST /v1/chat/completions (meta-llama/llama-4-maverick)", desc: "Llama 4 Maverick", amount: "270000", unitType: "1M tokens" },
      { route: "POST /v1/chat/completions (meta-llama/llama-4-scout)", desc: "Llama 4 Scout", amount: "180000", unitType: "1M tokens" },
      // ── Qwen ──
      { route: "POST /v1/chat/completions (qwen/qwen-2.5-72b-instruct)", desc: "Qwen 2.5 72B", amount: "360000", unitType: "1M tokens" },
      // ── Mistral ──
      { route: "POST /v1/chat/completions (mistralai/mistral-large)", desc: "Mistral Large", amount: "2000000", unitType: "1M tokens" },
      // ── Common endpoints ──
