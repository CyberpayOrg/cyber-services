...
Use `mpay.session` in your request handler to meter access:
...
:::info
See [`tempo.session` server reference](/sdk/typescript/server/Method.tempo.session) for the full parameter list.
:::
