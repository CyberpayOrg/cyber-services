...
A **Credential** is the client's response to a [Challenge](/protocol/challenges), proving that payment has been made or authorized. Credentials are sent in the `Authorization` header.
